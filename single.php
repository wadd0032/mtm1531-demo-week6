...
//Only connect to the database if there is an ID, because this comes after the above if-statement
//With out an ID there is no point connecting to the database
...
//No results will happen if they change the ?id=4 to indicate an ID that doesn't exist
if (empty($results)) {
	header('Location: index.php');
